   ...
   //On.click func
    function doOnClick(){
        ...
        $(".choose-human").on("click", function(){
            player1 = "X";
            console.log("Starting player is 'Human'!")
            $(".choose").css("display", "none");
            choosePlayer();
            playAgain();
        });
    
        $(".choose-robot").on("click", function(){
            player1 = "O";
            console.log("Starting player is 'Robot'!")
            $(".choose").css("display", "none");
            choosePlayer();
            playAgain();
            if(player2Name === "Computer"){
   ...
   //Define computer moves, check if there is wining combination and update whose turn is, return new playerboard
    function computerTurn(){
        ...
        if($('input[id=medium]:checked').val()){
            fieldName = aiMediumMove();
        }  
   ...
   //Reset all value and retur on very begining
    function resetGame(){
        ...
        $(".fields, .scores, .turn-info, .message, .choose-sign, .choose-player, .choose-level, .players-names ").css("display", "none");
   ...
   //1. AI Predict and define computer;s moves - level Easy
    function aiMove(){
     ...
     //2. AI Predict and define computer's moves - level Medium  
    ...
    } //end of aiMediumMove func
  
   //3. AI Predict and define computer's moves - level Hard 
